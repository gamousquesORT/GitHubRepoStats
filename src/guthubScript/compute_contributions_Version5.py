...
def pretty_print_results(results, files_by_author, show_files, file_creator=None, file_top_contrib=None, base_path=None):
    print()
...
def compute_file_level_info(path, exts, skip_patterns=None):
    ...
    Returns two dicts: (file_creator, file_top_contrib)
    """
    if skip_patterns is None:
        skip_patterns = ['bin/', 'obj/']
    try:
    ...
    for f in files:
        ...
        # determine creator (author of the commit that added the file)
        try:
...
if __name__ == "__main__":
    ...
    file_creator, file_top = compute_file_level_info(path, exts, skip_patterns=skip_patterns)
    pretty_print_results(results, files_by_author, args.output_files_per_author, file_creator, file_top, base_path=path)